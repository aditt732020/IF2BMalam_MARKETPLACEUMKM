    ...
    <main x-show="page === 'tentang'" x-cloak class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="bg-white border border-gray-100 rounded-2xl p-6 mb-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <a href="https://wa.me/6281364048919" target="_blank" rel="noopener" class="flex items-center gap-3 rounded-xl border border-gray-100 p-4 hover:bg-gray-50 transition">
                    <div class="w-10 h-10 rounded-full bg-[#fdf3e7] text-[#c57d38] flex items-center justify-center shrink-0">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-semibold text-gray-800">0813-6404-8919</p>
                    </div>
                </a>
                <a href="mailto:aditalfarizi732007@gmail.com" class="flex items-center gap-3 rounded-xl border border-gray-100 p-4 hover:bg-gray-50 transition">
                    <div class="w-10 h-10 rounded-full bg-[#fdf3e7] text-[#c57d38] flex items-center justify-center shrink-0">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-semibold text-gray-800 break-all">aditalfarizi732007@gmail.com</p>
                    </div>
                </a>
            </div>
        </div>
